...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="adminTea.jsp">数学类课程作业提交系统</a>
		</div>
		<ul class="nav navbar-nav navbar-right">
			<li><a href="adminTea.jsp"><span
	...
	<div class="main">
		<ul id="myTab" class="nav nav-pills side-nav">
			...
			<li class="active"><a href="adminTea.jsp" >老师</a></li>
			...
			<div>
				<table class="table table-hover">
					...
					<%
						...
						ResultSet rs2 = st.executeQuery("SELECT * FROM teacher");
						while (rs2.next()) {
					%>
					<tbody>
						<tr>
							<td><%=rs2.getString("teacher_id")%></td>
							<td><%=rs2.getString("teacher_name")%></td>
							<td><%=rs2.getString("teacher_password")%></td>
							<td>
								<%
									String teaId = rs2.getString("id");
								%>
								<form method="post" action=delTeaServlet
									class="form-inline my-form" role="form">
									<input name="id" type="hidden" value="<%=teaId%>">
